...
//------------------------------------------------------------------------------
void SADC_SetPinMode(SADC_CH_t tCH, SADC_PinMode_t tPinMode)
{
	if(SADC_PIN_ANALOG_INPUT_MODE == tPinMode)
		SARAD->REG_0x0020 &= ~(1 << tCH);
	else if(SADC_PIN_GPIO_MODE == tPinMode)
		SARAD->REG_0x0020 |= (1 << tCH);
}
//------------------------------------------------------------------------------
