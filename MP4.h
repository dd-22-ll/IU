...
#define MP4_MINORVER        (12)         // Minor version = 2

#define MP4_LOG_LV      DBG_InfoLvl

#define MP4_THUMBNAIL_SIZE      (0x10200)    //64.5K(0x8210)
#define MP4_SIMSTSZ_SIZE        (0x2800)     //5Min 5K BYTE  // 0x5000 10 Min
#define MP4_FTYPE_ATOM_SIZE     0x20         // 32 Bytes
#define MP4_MDAT_ATOM_SIZE      0x8          // 8 Bytes
#define MP4_FREE_ATOM_SIZE      (KNL_JPG_HEADER_SIZE-MP4_FTYPE_ATOM_SIZE-MP4_MDAT_ATOM_SIZE) // 65496 Bytes
#define MP4_HEAD_SIZE           (MP4_FTYPE_ATOM_SIZE+MP4_FREE_ATOM_SIZE+MP4_MDAT_ATOM_SIZE)

#define MP4_transfer_bitstream_to_MP4_format 1
//------------------------------------------------------------------------------
...
#define MP4_AVCC_SIZE			(89)
#define MP4_AVC1_SPS_SIZE		(101)
#define MP4_AVC1_SPS		    (102)
...
typedef struct _audio_sample_description_atom{
    ...
    //	alaw
    uint8_t ubDescriptionSize[32];  //ubReserve6 DataRefIndex ChannelCnt ubSampleSize ubPreDefine
    uint8_t ubSampleRate[4];
...
\param	ubCh Source Channel
\param	HidnInfo hidden information
\return	(no)
*/
void MP4_Close(uint8_t ubCh, FS_FILE_SUB_HIDN_INFO_t HidnInfo);
//------------------------------------------------------------------------------
/*!
\brief	Alignment movie length
\param	ubCh Source Channel
\return	Video:Current video frame no.;Audio:Need fill audio frame no.
*/
...
//------------------------------------------------------------------------
/*!
\brief	Get File Format Size Information
\param	Header Informaton, Ftype,Free,Mdat Size info
\return	(no)
*/
...
//------------------------------------------------------------------------------
/*!
\brief	Parsing Header info, Check audio format is aac or alaw.
\param	ubCh Source Channel
...
\return	0=Assignment Fail,1=success
*/
