...
*/
//------------------------------------------------------------------------------
#ifndef _BSP_SN93714_TX_H_
#define _BSP_SN93714_TX_H_
//======================================================================================================================
...
#endif
#ifdef S2019A
#define sPRF_PWR_CTRL(ctrl)			PWM->PWM1_HIGH_CNT = ctrl;
#define sPRF_PWR_RST				{												\
									sPRF_PWR_CTRL(0)								\
									osDelay(100);									\
									sPRF_PWR_CTRL(1)								\
...
//------------------------------------------------------------------------------
//! LED GPIO
#define	PAIRING_LED_IO				(PWM->PWM3_HIGH_CNT)
#define	PAIRING_LED_IO_ENABLE		(PWM->PWM_EN3)
#define POWER_LED_IO				(GPIO->GPIO_O6)
#define POWER_LED_IO_ENABLE			(GPIO->GPIO_OE6)
